<?php
    ...
    $mhs = query("SELECT * FROM mahasiswa_pribadi WHERE id = $id ")[0];
    // var_dump($mhs["nim"]);
    // die;
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <h1 class="text-center">Ubah Data Pribadi</h1>
                <hr>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <div class="card shadow-lg border-0">
                    <div class="card-body">
                        <h3>Form Ubah Data Pribadi</h3><hr>
                        <form action="" method="POST">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="ttl" id="ttl" value="<?= $mhs['ttl']; ?>">
                                <br>
                                <label for="alamat">Alamat</label>
                                <input type="text" class="form-control" name="alamat" id="alamat" value="<?= $mhs['alamat']; ?>">
                                <br>
                                <label for="agama">Agama</label>
                                <input type="text" class="form-control" name="agama" id="agama" value="<?= $mhs['agama']; ?>">
                                <br>
                                <label for="golongan_darah">Golongan darah</label>
                                <input type="text" class="form-control" name="golongan_darah" id="golongan_darah" value="<?= $mhs['golongan_darah']; ?>">
                                <br>
                                <label for="jalur_masuk">Jalur masuk</label>
                                <input type="text" class="form-control" name="jalur_masuk" id="jalur_masuk" value="<?= $mhs['jalur_masuk']; ?>">
                            </div>
                            <br>
                            
                            <div class="form-group">
                                <div class="float-sm-end">
                                <button type="submit" class="btn btn-primary btn-block" name="submit">Perbaharui Data Pribadi</button>
                                </div>
                            </div>
                            <br>
                        </form>
