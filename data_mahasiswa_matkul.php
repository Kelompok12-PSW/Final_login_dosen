<?php
    ...
    $mahasiswa = query("SELECT * FROM mahasiswa_matkul");
...
<div class="container">
    ...
    <div class="row">
        <div class="mt-2">
            <h1 class="text-left">DATA MATA KULIAH</h1><hr>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <label for="keyword">Mata Kuliah</label>
    ...
    <div class="float-sm-right">
        <button type='button' class="btn btn-outline-warning"><a href="tambah_data_matkul.php" data-bs-toggle="tooltip" data-bs-placement="top" title="Tambahkan data mahasiswa">Tambahkan Data Mata Kuliah</a></button>
    </div>
    <br>
    <br>
    ...
    <table border="5" cellpadding="0" cellspacing="0" class="table">
        ...
        <tbody>
            <tr>
                ...
                <td><?= $mhs["dosen_pengampu"]; ?></td>
                <td>
                    <button typr="submit" class="btn btn-outline-success" name="bsimpan"><a href="ubah_data_matkul.php?id=<?= $mhs['id']; ?>" onclick="return confirm('Yakin Mengubah Data?')" data-bs-toggle="tooltip" data-bs-placement="top" title="Perbaharui Data">Edit</a></button>
                    <button typr="reset" class="btn btn-danger" name="breset"><a href="hapus_data_matkul.php?id=<?= $mhs['id']; ?>" onclick="return confirm('Yakin Menghapus Data?')" data-bs-toggle="tooltip" data-bs-placement="top" title="Hapus Data">Hapus</a> </button>
