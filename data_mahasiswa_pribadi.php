<?php
    ...
    $mahasiswa = query("SELECT * FROM mahasiswa_pribadi");
...
<div class="container">
    ...
    <div class="row">
        <div class="mt-5">
            <h1 class="text-left">DATA PRIBADI</h1><hr>
        </div>
    </div>
    ...
    <div class="float-sm-right">
        <button type='button' class="btn btn-outline-warning"><a href="tambah_data_pribadi.php" data-bs-toggle="tooltip" data-bs-placement="top" title="Tambahkan data mahasiswa">Tambahkan Data</a></button>
    </div>
    <br>
    <br>
    ...
    <table border="2" cellpadding="5" class="table">
        ...
        <tbody>
            <tr>
                ...
                <td>
                    <button typr="submit" class="btn btn-outline-success" name="bsimpan"><a href="ubah_data_pribadi.php?id=<?= $mhs['id']; ?>" onclick="return confirm('Yakin Mengubah Data?')" data-bs-toggle="tooltip" data-bs-placement="top" title="Perbaharui Data">Edit</a></button>
                    <button typr="reset" class="btn btn-danger" name="breset"><a href="hapus_data_pribadi.php?id=<?= $mhs['id']; ?>" onclick="return confirm('Yakin Menghapus Data?')" data-bs-toggle="tooltip" data-bs-placement="top" title="Hapus Data">Hapus</a> </button>
