<?php
    ...
    $mahasiswa = query("SELECT * FROM mahasiswa_prodi");

    // periksa apakah tombol dengan name=cari sudah ditekan
    if ( isset($_POST["cari"] ) ) {
        // panggil function cari, simpan dalam variable 
...
<div class="container">
    ...
    <div class="row">
        <div class="mt-5">
            <h1 class="text-left">DATA PRODI</h1><hr>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <label for="keyword">Fakultas</label>
    ...
    <div class="float-sm-right">
        <button type='button' class="btn btn-outline-warning"><a href="tambah_data_prodi.php" data-bs-toggle="tooltip" data-bs-placement="top" title="Tambahkan data mahasiswa">Tambahkan Data Prodi</a></button>
    </div>
    <br>
    <br>
    ...
    <table border="5" cellpadding="0" cellspacing="0" class="table">
        ...
        <tbody>
            <tr>
                ...
                <td><?= $mhs["fakultas"]; ?></td>
                <td>
                    <button typr="submit" class="btn btn-outline-success" name="bsimpan"><a href="ubah_data_prodi.php?id=<?= $mhs['id']; ?>" onclick="return confirm('Yakin Mengubah Data?')" data-bs-toggle="tooltip" data-bs-placement="top" title="Perbaharui Data">Edit</a></button>
                    <button typr="reset" class="btn btn-danger" name="breset"><a href="hapus_data_prodi.php?id=<?= $mhs['id']; ?>" onclick="return confirm('Yakin Menghapus Data?')" data-bs-toggle="tooltip" data-bs-placement="top" title="Hapus Data">Hapus</a> </button>
